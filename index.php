            ...
            <form action="#" id="formulario">
                ...
                <div> <!--<div class="input-group"">
                    ...
                    <div class="identificacion">
                        ...
                        <input class="input5" id="documento" type="text" minlength="8" maxlength="8" placeholder="Nro de documento" requerid>
                    </div>
                      <!--<div class="input-box">
                    </div>-->
                    
                    <div class="input-box">
                        <input type="text" id="numeroTarjeta" placeholder="Número de tarjeta" requerid>
                      </div>
